...
public class DiretorReserva {
    ...
    public Reserva builder(Pagamento pagamento, Veiculo veiculo, Vaga vaga, String horaReserva, String dataReserva, String horaSaida,double valor, String data, boolean status, String cnh,String placa, int ano, String modelo, String marca, String cor, int numero)throws Exception{
        Reserva reserva = new Reserva();
        BuilderReserva BR = new BuilderReserva(reserva, pagamento, veiculo, vaga);
        BR.addReserva(horaReserva, dataReserva, horaSaida);
        BR.addPagamento(valor, data, status, cnh);
